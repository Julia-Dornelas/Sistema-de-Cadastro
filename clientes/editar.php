                ...
                <form action="edit.php" method="post">
                    ...
                    <div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="exampleRadios1"  value="0"  <?php if(!$item->sexo){echo "checked";} ?> name="campoSexo">
                            <label class="form-check-label" for="exampleRadios1">Masculino</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="exampleRadios2" value="1" <?php if($item->sexo){echo "checked";} ?> name="campoSexo">
